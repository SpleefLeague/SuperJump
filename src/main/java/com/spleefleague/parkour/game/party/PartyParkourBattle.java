 ...
 * @author jonas
 */
public class PartyParkourBattle extends ParkourBattle<PartyParkourArena>{

    protected PartyParkourBattle(PartyParkourArena arena, List<ParkourPlayer> players) {
        super(arena, players);
    }
