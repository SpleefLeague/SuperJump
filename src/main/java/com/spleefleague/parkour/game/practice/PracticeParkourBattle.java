 ...
 * @author jonas
 */
public class PracticeParkourBattle extends ParkourBattle<PracticeParkourArena>{

    protected PracticeParkourBattle(PracticeParkourArena arena, List<ParkourPlayer> players) {
        super(arena, players);
    }
